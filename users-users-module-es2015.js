...
class AddEditComponent {
    ...
    ngOnInit() {
        ...
        if (!this.isAddMode) {
            ...
            this.vacationService.getAll()
                ...
                .subscribe(vacs => {
                const vac = vacs.find(v => v.id === this.id);
    ...
    createVacation() {
        ...
        this.vacationService.createVacation(newVac)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])())
            .subscribe(data => {
...
AddEditComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AddEditComponent, selectors: [["app-add-edit"]], decls: 43, vars: 23, consts: [[4, "ngIf"], [3, "formGroup", "ngSubmit"], [1, "vac-input"], ["matInput", "", "formControlName", "title", "required", ""], ["class", "vh-invalid-feedback", 4, "ngIf"], ["matInput", "", "formControlName", "description"], ["formControlName", "type", "required", ""], [3, "value"], ["mat-flat-button", "", "color", "primary", 3, "disabled"], ["mat-button", "", "color", "primary", "routerLink", "/users"], [1, "vh-invalid-feedback"]], template: function AddEditComponent_Template(rf, ctx) { if (rf & 1) {
...
ListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ListComponent, selectors: [["app-user-list"]], decls: 8, vars: 1, consts: [["svgIcon", "search", "matPrefix", "", 1, "vh-prefix-icon"], ["matInput", "", "placeholder", "Filter", 3, "keyup"], ["mat-table", "", "class", "mat-elevation-z8", 3, "dataSource", 4, "ngIf"], ["mat-table", "", 1, "mat-elevation-z8", 3, "dataSource"], ["matColumnDef", "select"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "username"], ["mat-cell", "", "class", "name-cell", 3, "matTooltip", 4, "matCellDef"], ["matColumnDef", "id"], ["mat-cell", "", "class", "email-cell", 3, "matTooltip", 4, "matCellDef"], ["matColumnDef", "image"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 3, "click", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], [3, "checked", "indeterminate", "aria-label", "change"], ["mat-cell", ""], [3, "checked", "aria-label", "click", "change"], ["mat-cell", "", 1, "name-cell", 3, "matTooltip"], ["mat-cell", "", 1, "email-cell", 3, "matTooltip"], [1, "vh-user-image", 3, "src"], ["mat-header-row", ""], ["mat-row", "", 3, "click"]], template: function ListComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h1");
...
function VacationTypeIconComponent_mat_icon_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-icon", 9);
} }
function VacationTypeIconComponent_mat_icon_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-icon", 10);
} }
function VacationTypeIconComponent_mat_icon_3_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-icon", 11);
} }
function VacationTypeIconComponent_mat_icon_4_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-icon", 12);
} }
function VacationTypeIconComponent_mat_icon_5_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-icon", 13);
} }
function VacationTypeIconComponent_mat_icon_6_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-icon", 14);
} }
function VacationTypeIconComponent_mat_icon_7_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-icon", 15);
} }
function VacationTypeIconComponent_mat_icon_8_Template(rf, ctx) { if (rf & 1) {
...
VacationTypeIconComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: VacationTypeIconComponent, selectors: [["app-vacation-type-icon"]], inputs: { vacationType: "vacationType" }, decls: 9, vars: 9, consts: [[3, "ngSwitch", "matTooltip"], ["svgIcon", "travel", "color", "accent", 4, "ngSwitchCase"], ["svgIcon", "cruise", "color", "accent", 4, "ngSwitchCase"], ["svgIcon", "flight", "color", "accent", 4, "ngSwitchCase"], ["svgIcon", "sports", "color", "accent", 4, "ngSwitchCase"], ["svgIcon", "shopping", "color", "accent", 4, "ngSwitchCase"], ["svgIcon", "business", "color", "accent", 4, "ngSwitchCase"], ["svgIcon", "virtual", "color", "accent", 4, "ngSwitchCase"], ["svgIcon", "other", "color", "accent", 4, "ngSwitchDefault"], ["svgIcon", "travel", "color", "accent"], ["svgIcon", "cruise", "color", "accent"], ["svgIcon", "flight", "color", "accent"], ["svgIcon", "sports", "color", "accent"], ["svgIcon", "shopping", "color", "accent"], ["svgIcon", "business", "color", "accent"], ["svgIcon", "virtual", "color", "accent"], ["svgIcon", "other", "color", "accent"]], template: function VacationTypeIconComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgSwitch"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_3__["MatTooltip"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgSwitchCase"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgSwitchDefault"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_4__["MatIcon"]], encapsulation: 2 });
...
VaclistComponent.ɵfac = function VaclistComponent_Factory(t) { return new (t || VaclistComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services__WEBPACK_IMPORTED_MODULE_3__["VacationService"])); };
VaclistComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: VaclistComponent, selectors: [["app-vac-list"]], decls: 11, vars: 2, consts: [["mat-flat-button", "", "color", "accent", "routerLink", "add"], ["svgIcon", "search", "matPrefix", "", 1, "vh-prefix-icon"], ["matInput", "", "placeholder", "Filter", 3, "keyup"], ["class", "vh-spinner-container", 4, "ngIf"], ["mat-table", "", "class", "mat-elevation-z8", 3, "dataSource", 4, "ngIf"], [1, "vh-spinner-container"], ["color", "accent"], ["mat-table", "", 1, "mat-elevation-z8", 3, "dataSource"], ["matColumnDef", "title"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", "class", "title-cell", 3, "matTooltip", 4, "matCellDef"], ["matColumnDef", "description"], ["mat-cell", "", "class", "description-cell", 3, "matTooltip", 4, "matCellDef"], ["matColumnDef", "type"], ["mat-header-cell", "", "class", "icon-column", 4, "matHeaderCellDef"], ["mat-cell", "", "class", "icon-column", 4, "matCellDef"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], ["mat-cell", "", 1, "title-cell", 3, "matTooltip"], ["mat-cell", "", 1, "description-cell", 3, "matTooltip"], ["mat-header-cell", "", 1, "icon-column"], ["mat-cell", "", 1, "icon-column"], [3, "vacationType"], ["mat-header-row", ""], ["mat-row", ""]], template: function VaclistComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h1");
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](VaclistComponent, [{
    ...
    }], function () { return [{ type: _services__WEBPACK_IMPORTED_MODULE_3__["VacationService"] }]; }, null); })();
