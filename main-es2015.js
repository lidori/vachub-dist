...
class AppComponent {
    ...
    showRest() {
        this.getRest().subscribe(result => this.fromRest = JSON.stringify(result), error => console.log(error));
    }
    getRest() {
